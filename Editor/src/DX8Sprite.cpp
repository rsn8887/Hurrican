...
#include <d3dx8.h>										// F�r die Texturen
#include <d3dx8math.h>									// F�r D3DXVECTOR2
#include "Globals.h"
#include "Logdatei.h"
...
RECT					ClippingArea;						// R�nder f�r das Clipping
VERTEX2D				v1, v2, v3, v4;						// Vertices zum Sprite rendern
VERTEX2D				TriangleStrip[4];					// Strip f�r ein Sprite
...
// --------------------------------------------------------------------------------------
// Laden des Bildes "Filename" mit Gr�sse xSize, ySize in die Surface
// --------------------------------------------------------------------------------------
...
bool DirectGraphicsSurface::LoadImage(char Filename[100], int xSize, int ySize)
{
	...
	if(hresult != D3D_OK)
	{
		strcpy(Temp, "Fehler beim Surface-Erstellen f�r ");
...
//		Protokoll.WriteText(" Sprite Textur(en) �brig !\n", false);
	}
}

// --------------------------------------------------------------------------------------
// Laden des Bildes "Filename" 
// xfs, yfs Gr�sse eines Frames
														 ...
														 int xfc,  int yfc)
{
	...
	hresult = D3DXCreateTextureFromFileEx(
			  lpD3DDevice,
			  Name,
			  NULL, NULL,				  // x und y Gr�sse des Sprites (aus Datei �bernehmen)
	...
	strcat(Temp, " erfolgreich ! \n");
	Protokoll.WriteText(Temp, false);			
	LoadedTextures++;							// Anzahl der geladenen Texturen erh�hen	
...
// --------------------------------------------------------------------------------------
// Sprite mit �bergebenem Winkel rotiert darstellen
// --------------------------------------------------------------------------------------
