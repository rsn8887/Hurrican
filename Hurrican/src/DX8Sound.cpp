...
//
// SoundManager
// zum Abspielen von Wave-Dateien und Musikst�cken mit Hilfe der FMOD Library
//
//
...
// R�ckgabewert	: String mit Error-Text
...
// Aufgabe		: Standardm�ssige Initialisierung
// R�ckgabewert	: Keiner
// Parameter	: Keine
//---------------------------------------------------------------------------------------
...
//---------------------------------------------------------------------------------------
// Name			: CSoundManager (�berladener Konstruktor)
// Aufgabe		: Initialisierung mit �bergebenen Parametern
// R�ckgabewert	: Keiner
// Parameter	: Keine
//---------------------------------------------------------------------------------------
...
// R�ckgabewert	: true bei Erfolg, false bei nicht-Erfolg
// Parameter	: keine
//---------------------------------------------------------------------------------------
...
// R�ckgabewert	: keiner
// Parameter	: Sound		neue Sound-Lautst�rke
//				  Musik		neue Musik-Lautst�rke
//---------------------------------------------------------------------------------------
...
// Name			: LoadSong
// Aufgabe		: Song laden
// R�ckgabewert	: Liefert Integer Wert der Arraypos des Songs zur�ck, -1 bei Fehler
...
// R�ckgabewert	: false, wenn der Song nicht exisitert, sonst true
// Parameter	: Nr		Array-Nummer des Songs
...
//---------------------------------------------------------------------------------------
// Name			: SetSongVolume
// Aufgabe		: Lautst�rke eines Songs setzen
// R�ckgabewert	: keiner
// Parameter	: Nr		Array-Nummer des Songs
//				  Volume	Zu setzende Lautst�rke
//---------------------------------------------------------------------------------------
...
// Aufgabe		: aboslute Lautst�rke eines Songs setzen
// R�ckgabewert	: keiner
// Parameter	: Nr		Array-Nummer des Songs
//				  Volume	Zu setzende Lautst�rke
//---------------------------------------------------------------------------------------
...
// Aufgabe		: Lautst�rke aller Songs setzen
// R�ckgabewert	: keiner
// Parameter	: keine
//---------------------------------------------------------------------------------------
...
//---------------------------------------------------------------------------------------
// Name			: Update
// Aufgabe		: Songs bei Bedarf faden und benutzte Channels z�hlen usw
// R�ckgabewert	: keiner
// Parameter	: keine
//---------------------------------------------------------------------------------------
...
void CSoundManager::Update(void)
{
	...
	// Anzahl benutzter Channels z�hlen
	//
	ChannelsUsed = 0;
...
//---------------------------------------------------------------------------------------
// Name			: FadeSong
// Aufgabe		: Fadet einen Song ein/aus und h�lt danach an bzw pausiert
// R�ckgabewert	: keiner
...
//---------------------------------------------------------------------------------------
// Name			: LoadWave
// Aufgabe		: L�dt eine Wave Datei
// R�ckgabewert	: Nr der Wavedatei im Array
...
loadfile:
	...
	// Temp Datei wieder l�schen und Speicher freigeben
	//DeleteFile("temp.dat");
	//free(pData);
...
// R�ckgabewert	: true, wenn der Sound gespielt wurde, sonst false
...
bool CSoundManager::PlayWave(int Vol, int Pan, int Freq, int Nr)
{
	...
	// Und Werte f�r den Channel, in dem er gespielt wird, setzen
	//
...
//				  und setzt das panning entsprechend der Position der Ger�uschquelle
// R�ckgabewert	: true, wenn der Sound gespielt wurde, sonst false
// Parameter	: Nr des Sounds im Array
//---------------------------------------------------------------------------------------
...
// --------------------------------------------------------------------------------------
// Lautst�rke eines 3D sounds �ndern
// --------------------------------------------------------------------------------------
